...
namespace Morpho.Migrations
{
    ...
    [Migration("20251125163351_Update_IoT_Model")]
    partial class Update_IoT_Model
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Morpho.Domain.Entities.Events.DeviceEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Morpho.Domain.Entities.Shipments.Container", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Morpho.Domain.Entities.Shipments.Package", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Morpho.Domain.Entities.Shipments.Shipment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Morpho.Domain.Entities.Shipments.Container", b =>
                {
                    b.HasOne("Morpho.Domain.Entities.Shipments.Shipment", null)
                        .WithMany("Containers")
            ...
            modelBuilder.Entity("PolicyViolation", b =>
                {
                    ...
                    b.HasOne("Morpho.Domain.Entities.Policies.Policy", null)
                        .WithMany("Violations")
                        .HasForeignKey("PolicyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Morpho.Domain.Entities.Policies.PolicyRule", null)
                        .WithMany("Violations")
                        .HasForeignKey("PolicyRuleId");
                });
