        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameAr = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    NameEn = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    PhoneCode = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    vehicle_type_name = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenantDocuments_AbpTenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AbpTenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationNumber = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    TaxNumber = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    Lei = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    EoriNumber = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenantProfiles_AbpLanguages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "AbpLanguages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TenantProfiles_AbpTenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AbpTenants",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TenantProfiles_CompanyTypes_CompanyTypeId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TenantProfiles_Countries_CountryId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TenantProfiles_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalSchema: "public",
                        principalTable: "Currencies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TenantProfiles_Industries_IndustryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantProfiles_CompanyTypeId",
                schema: "TenantManagement",
                table: "TenantProfiles",
                column: "CompanyTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantProfiles_CountryId",
                schema: "TenantManagement",
                table: "TenantProfiles",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantProfiles_CurrencyId",
                schema: "TenantManagement",
                table: "TenantProfiles",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantProfiles_IndustryId",
                schema: "TenantManagement",
                table: "TenantProfiles",
                column: "IndustryId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantProfiles_LanguageId",
                schema: "TenantManagement",
                table: "TenantProfiles",
                column: "LanguageId");
