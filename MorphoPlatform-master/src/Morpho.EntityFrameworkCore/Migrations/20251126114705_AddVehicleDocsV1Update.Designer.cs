...
namespace Morpho.Migrations
{
    ...
    [Migration("20251126114705_AddVehicleDocsV1Update")]
    partial class AddVehicleDocsV1Update
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Morpho.Domain.Entities.VehicleDocument.VehicleDocument", b =>
                {
                    ...
                    b.Property<long?>("mainVehicleDocumentTypeId")
                        .HasColumnType("bigint");

                    b.Property<long?>("mainVehiclesId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("mainVehicleDocumentTypeId");

                    b.HasIndex("mainVehiclesId");
            ...
            modelBuilder.Entity("Morpho.Domain.Entities.VehicleDocument.VehicleDocument", b =>
                {
                    b.HasOne("Morpho.Domain.Entities.VehicleDocumentType.VehicleDocumentType", "mainVehicleDocumentType")
                        .WithMany()
                        .HasForeignKey("mainVehicleDocumentTypeId");

                    b.HasOne("Morpho.Domain.Entities.Vehicles.Vehicles", "mainVehicles")
                        .WithMany()
                        .HasForeignKey("mainVehiclesId");
