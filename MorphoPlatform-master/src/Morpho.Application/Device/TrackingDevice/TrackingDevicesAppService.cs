...
{
    public class TrackingDevicesAppService : ApplicationService, ITrackingDevicesAppService
    {
        private readonly IRepository<TrackingDevices, long> _deviceRepository;
        private readonly MorphoDbContext _context;

        public TrackingDevicesAppService(IRepository<TrackingDevices, long> deviceRepository, MorphoDbContext context)
        {
