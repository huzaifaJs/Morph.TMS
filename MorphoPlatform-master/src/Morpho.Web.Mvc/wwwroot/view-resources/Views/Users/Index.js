        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: (data, type, row, meta) => {
                    const userName = $('<div>').text(row.name || '').html(); // Escape HTML
                    ...
                    return [
                        `   <button type="button" class="btn btn-sm bg-secondary edit-user" data-user-id="${userId}" data-toggle="modal" data-target="#UserEditModal">`,
                        `       <i class="fas fa-pencil-alt"></i> ${l('Edit')}`,
                        '   </button>',
                        `   <button type="button" class="btn btn-sm bg-danger delete-user" data-user-id="${userId}" data-user-name="${userName}">`,
